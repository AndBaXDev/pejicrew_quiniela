...
function esBloqueado(partido) {
  ...
  return Date.now() >= new Date(partido.fecha).getTime() - 30 * 60 * 1000;
}
  ...
  return (
    <div className="min-h-screen bg-metal-950">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
            ...
            <div className="flex-1 min-w-0">
              ...
              <ul className="mt-1 space-y-0.5">
                {proximosSinPred.map((p) => (
                  <li key={p.id} className="text-yellow-500 text-xs font-mono">
        ...
        {partidosFiltrados.length === 0 && partidos.length > 0 && (
